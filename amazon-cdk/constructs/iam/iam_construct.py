...
class IAMConstruct(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, *, app_env: str, **kwargs) -> None:
        ...
        password = core.SecretValue.plain_text(Param.value_for_string_parameter(self, f'/{app_env}/IAM_PASSWORD'))
        user = iam.User(self, "open-source-user", password=password)
